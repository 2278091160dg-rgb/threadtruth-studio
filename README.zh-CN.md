...
- 单风格预览覆盖：已验收 `0/24`。目标是**同一件白色马甲，24 个风格各一张预览；每张只有一种风格、六个姿势**。图库缩略图展示整张六宫格，点击查看完整预览，保留“方向预览／非成片”标记。beta.2 开发工具误做成四张混合风格看板，该方案已被取代，工具仍需返工；不能声称已实现或完成这 24 张案例。未验收预览不公开、不计数。
